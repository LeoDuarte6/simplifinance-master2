...
export class DashboardManager {
    ...
    updateForCancelled(userData) {
        ...
        UIHelpers.updateElementText('dashboard-next-billing', `Cancelled on ${cancelledDate.toLocaleDateString()}`);
    ...
    updateForActive(userData) {
        ...
        if (userData.createdAt) {
            ...
            UIHelpers.updateElementText('dashboard-next-billing', nextBilling.toLocaleDateString());
        }
